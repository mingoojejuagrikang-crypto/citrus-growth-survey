 ...
 * - '거실', '마실사', '사실' → 과실 (fruitNo)
 */
export const FIELD_ALIASES: Record<string, string[]> = {
  // 횡경 — 로그 확인 오인식: 형경, 황경, 생경, 빙빙경, 변경, 안경, 챙겨, 행경, 행정, 인경, 행병
  width: [
    '횡경',
    '형경',
    '황경',
  ...
  // 종경 — 로그 확인 오인식: 존경, 동경, 은경, 신경, 홍경, 민경, 보경, 성경, 진경, 용경
  height: ['종경', '중경', '종 경', '존경', '동경', '은경', '신경', '홍경', '민경', '보경', '성경', '진경', '용경'],
