 ...
 */
export function makeRecordId(fields) {
    const { surveyDate, farmerName, label, treatment, treeNo, fruitNo } = fields;
    return [surveyDate, farmerName, label, treatment, String(treeNo), String(fruitNo)].join(KEY_SEPARATOR);
}
/**
 * 세션 키를 생성합니다.
 ...
 */
export function makeSessionKey(fields) {
 ...
 * @returns 동일하면 true
 */
export function isSameRecord(a, b) {
 ...
 */
export function buildRecordKeys(fields) {
    return {
