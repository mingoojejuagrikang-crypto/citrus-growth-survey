...
export function validateRecord(record) {
    ...
    const numericFields = ['width', 'height', 'fruitWeight', 'pericarpThickness', 'brix', 'acidContent'];
 ...
 */
export function isVoiceOverflowWarning(value) {
 ...
 */
export function getValidationRange(key) {
